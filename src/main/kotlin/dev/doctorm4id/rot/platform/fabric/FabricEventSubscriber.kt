...
import dev.doctorm4id.rot.event.ExampleEventHandler // sample_content
...
class FabricEventSubscriber {
	...
	fun registerEvents() {
		//? != 1.20.1 {
		// sample_content
		ServerLivingEntityEvents.AFTER_DAMAGE.register(ServerLivingEntityEvents.AfterDamage { entity: LivingEntity?, source: DamageSource?, baseDamage: Float, damageTaken: Float, blocked: Boolean ->  // sample_content
